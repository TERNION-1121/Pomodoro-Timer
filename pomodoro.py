...
def displayButton(**buttons: tuple):    # displayButton(item = ((), ()))
    buttonsToFade = []
...
# sound setup
button_select = pygame.mixer.Sound(r"sound_effects\button_select.mp3")
    ...
    for event in pygame.event.get():
        ...
        match status:
            ...
            case "ticking":
                ...
                pygame.mixer.music.load(r"sound_effects\argon.mp3")
